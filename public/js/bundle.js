...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmphbW1pbjEzNCIsImEiOiJjbWV1NHR0OXQwM2hjMmlwbDBsN2hxanhkIn0.PY-Yx1Nl18lvuIJxBeCPbw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bjammin134/cmeu52tnd00vg01r98tg6ac4e',
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(type), " updated successfully!"));
          }
          _context.n = 3;
          break;
        case 2:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51S3IdSLTEuZx7stWg4Q7sA6bQ0jP2hWHMb3QaSnjMKydoWF7veO2FgEFVxOx5BzKm5SY2oyILitM9L2qyqfxaA0E00L9MgxaIt');
